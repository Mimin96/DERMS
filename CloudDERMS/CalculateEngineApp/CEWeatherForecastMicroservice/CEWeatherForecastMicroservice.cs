...
namespace CEWeatherForecastMicroservice
{
    ...
    /// </summary>
    internal sealed class CEWeatherForecastMicroservice : StatelessService
    {
        public CEWeatherForecastMicroservice(StatelessServiceContext context)
            : base(context)
        { }
        ...
        protected override async Task RunAsync(CancellationToken cancellationToken)
        {
            ...
            long iterations = 0;
            ServiceEventSource.Current.Message("CEWeatherForecastMicroservice, Up and running.");
            while (true)
            {
