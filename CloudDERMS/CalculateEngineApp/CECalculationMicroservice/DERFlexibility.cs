...
{
	public class DERFlexibility : IDERFlexibility
	{
		...
		public async Task<bool> CheckFlexibilityForManualCommanding(long gid, Dictionary<long, IdentifiedObject> model)
		{
		...
		#region NetworkModel
		public async Task CalculateNewDerForecastDayAheadForNetworkModel(double flexibilityValue, Dictionary<long, DerForecastDayAhead> derForcast, long gid, Dictionary<long, IdentifiedObject> affectedEntities)
		{
			int numOfHour = -1;
			bool finished = false;
		...
		public async Task CalculateNewDerForecastDayAheadForGeoRegion(double flexibilityValue, Dictionary<long, DerForecastDayAhead> derForcast, long gid, Dictionary<long, IdentifiedObject> affectedEntities)
		{
		...
		#region SubGeoRegion
		public async Task CalculateNewDerForecastDayAheadForSubGeoRegion(double flexibilityValue, Dictionary<long, DerForecastDayAhead> derForcast, long gid, Dictionary<long, IdentifiedObject> affectedEntities)
		{
		...
		#region Substation
		public async Task CalculateNewDerForecastDayAheadForSubstation(double flexibilityValue, Dictionary<long, DerForecastDayAhead> derForcast, long gid, Dictionary<long, IdentifiedObject> affectedEntities)
		{
		...
		#region Generator
		public async Task CalculateNewDerForecastDayAheadForGenerator(double flexibilityValue, Dictionary<long, DerForecastDayAhead> derForcast, long gid, Dictionary<long, IdentifiedObject> affectedEntities)
		{
			SubGeographicalRegion subGeographicalRegion = null;
			GeographicalRegion geographicalRegion = null;
