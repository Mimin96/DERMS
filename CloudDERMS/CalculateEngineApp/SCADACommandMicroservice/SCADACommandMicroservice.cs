...
namespace SCADACommandMicroservice
{
    ...
    /// </summary>
    internal sealed class SCADACommandMicroservice : StatelessService
    {
        public SCADACommandMicroservice(StatelessServiceContext context)
            : base(context)
        { }
        ...
        protected override async Task RunAsync(CancellationToken cancellationToken)
        {
            ...
            long iterations = 0;
            ServiceEventSource.Current.Message("SCADACommandMicroservice, Up and running.");
            while (true)
            {
