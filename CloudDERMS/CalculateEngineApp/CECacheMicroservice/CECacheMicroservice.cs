...
namespace CECacheMicroservice
{
    ...
    /// </summary>
    internal sealed class CECacheMicroservice : StatefulService
    {
        public CECacheMicroservice(StatefulServiceContext context)
            : base(context)
        { }
        ...
        protected override async Task RunAsync(CancellationToken cancellationToken)
        {
            ...
            ServiceEventSource.Current.Message("CECacheMicroservice, Up and running.");
