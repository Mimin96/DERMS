...
namespace TreeConstructionMicroservice
{
    ...
    /// </summary>
    internal sealed class TreeConstructionMicroservice : StatelessService
    {
        public TreeConstructionMicroservice(StatelessServiceContext context)
            : base(context)
        { }
        ...
        protected override async Task RunAsync(CancellationToken cancellationToken)
        {
            ...
            long iterations = 0;
            ServiceEventSource.Current.Message("CETreeConstructionMicroservice, Up and running.");
            while (true)
            {
