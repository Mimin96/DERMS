...
namespace DERMSCommon.WeatherForecast
{
    public static class SPACalculator
    {
        public struct SPAData
        {
            ...
            public void SetUpData(double latitude, double longitude, HourDataPoint hourDataPoint)
            {
                Year = 2019;
                Month = 1;
                Day = hourDataPoint.Time.Day;
                Hour = hourDataPoint.Time.Hour;
                Minute = hourDataPoint.Time.Minute;
                Second = hourDataPoint.Time.Second;
                Timezone = 1.0;
                DeltaUt1 = 0;
                DeltaT = 67;
                Longitude = longitude;
